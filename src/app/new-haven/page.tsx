        ...
        <section className="space-y-10">
          ...
          <div className="space-y-4">
            ...
            <p className="text-white/80">
              We provide reliable dumpster rental services throughout New Haven, CT and surrounding areas. Whether you&apos;re a homeowner tackling a renovation, a contractor managing a construction site, or a business needing regular waste removal, we have the right dumpster size for your project.
            </p>
            <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-semibold text-white">Serving New Haven Neighborhoods</h2>
            <p className="text-white/80">
              We deliver dumpsters throughout New Haven including downtown, East Rock, Westville, Fair Haven, Wooster Square, and all surrounding neighborhoods. Our local knowledge ensures accurate delivery and pickup scheduling.
            </p>
          </div>
        </section>
