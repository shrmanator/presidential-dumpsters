        ...
        <section className="space-y-10">
          ...
          <div className="space-y-4">
            ...
            <p className="text-white/80">
              Serving Wolcott, CT with reliable roll-off dumpster rentals. Perfect for home renovations, spring cleaning, basement cleanouts, roofing projects, and landscaping work. We understand the unique needs of Wolcott properties and provide personalized service.
            </p>
            <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-semibold text-white">Why Choose Us in Wolcott</h2>
            <p className="text-white/80">
              As a local service, we know Wolcott neighborhoods and can navigate residential streets with ease. Our team provides prompt delivery, helpful guidance on sizing, and reliable pickup scheduling that respects your property.
            </p>
          </div>
        </section>
